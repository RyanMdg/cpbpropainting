...
const kidsNurseryWallpapers: WallpaperItem[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1541123603104-512919d6a96c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Safari",
    room: "Nursery",
    description: "Monochrome jungle scene with tropical palms and safari animals - perfect for a gender-neutral nursery",
  },
  {
    id: 2,
    title: "Space Explorer",
    image: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Space",
    room: "Bedroom",
    description: "Vibrant space adventure with planets, rockets, and astronauts exploring the galaxy",
  },
  {
    id: 3,
    title: "Woodland Animals",
    image: "https://images.unsplash.com/photo-1518012312832-96uj89c9c7dd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Animals",
    room: "Nursery",
    description: "Charming woodland creatures including foxes, bears, and deer in a forest setting",
  },
  {
    id: 4,
    title: "Safari Giraffe",
    image: "https://images.unsplash.com/photo-1547721064-da6cfb341d50?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Safari",
    room: "Playroom",
    description: "Stunning African savanna mural featuring giraffes and acacia trees",
  },
  {
    id: 5,
    title: "Princess Dreams",
    image: "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Princess",
    room: "Girls Room",
    description: "Dreamy pink room design with fairy tale magic for little princesses",
  },
  {
    id: 6,
    title: "World Map Adventure",
    image: "https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Educational",
    room: "Playroom",
    description: "Vintage-style world map with hot air balloons and airplanes - educational and beautiful",
  },
  {
    id: 7,
    title: "Sweet Dreams Moon",
    image: "https://images.unsplash.com/photo-1532978379173-523e16f371f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Dreamy",
    room: "Nursery",
    description: "Soft gray moon and stars design creating a calm, peaceful sleeping environment",
  },
  {
    id: 8,
    title: "Hot Air Balloons",
    image: "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Adventure",
    room: "Bedroom",
    description: "Whimsical hot air balloons floating over pastel mountain peaks",
  },
  {
    id: 9,
    title: "Dinosaur World",
    image: "https://images.unsplash.com/photo-1606567595334-d39972c85dfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Dinosaurs",
    room: "Boys Room",
    description: "Friendly dinosaurs in a prehistoric jungle setting - perfect for dino lovers",
  },
  {
    id: 10,
    title: "Botanical Ferns",
    image: "https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Botanical",
    room: "Nursery",
  ...
  },
  {
    id: 11,
    title: "Under The Sea",
    image: "https://images.unsplash.com/photo-1682687220742-aba13b6e50ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Ocean",
    room: "Bathroom",
    description: "Magical underwater world with friendly fish, whales, and coral reefs",
  },
  {
    id: 12,
...
const luxuryWallpapers: WallpaperItem[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Classic",
    room: "Living Room",
    description: "Timeless damask pattern with rich gold and deep navy accents in an elegant living space",
  },
  {
    id: 2,
    title: "Marble Elegance",
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Modern",
    room: "Bathroom",
    description: "Sophisticated marble texture wallpaper with subtle gold veining",
  },
  {
    id: 3,
    title: "Art Deco Gold",
    image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Art Deco",
    room: "Dining Room",
    description: "Geometric art deco patterns in luxurious metallic gold finishes",
  },
  {
    id: 4,
    title: "Tropical Paradise",
    image: "https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Botanical",
    room: "Bedroom",
    description: "Lush tropical palm leaves and botanical prints for a resort-style bedroom",
  },
  {
    id: 5,
    title: "Abstract Waves",
    image: "https://images.unsplash.com/photo-1557682250-33bd709cbe85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Abstract",
    room: "Living Room",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545083036-b175dd155a1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Oriental",
    room: "Study",
    description: "Exquisite hand-painted style chinoiserie with birds and florals",
  },
  {
    id: 7,
    title: "Dark Floral Drama",
    image: "https://images.unsplash.com/photo-1490750967868-88aa4486c946?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Floral",
    room: "Dining Room",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Modern",
    room: "Office",
    description: "Contemporary geometric pattern in champagne and metallic tones",
  },
  {
    id: 9,
    title: "Velvet Texture",
    image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Textured",
    room: "Bedroom",
  ...
  },
  {
    id: 10,
    title: "Mural Scenic",
    image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Mural",
    room: "Living Room",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    style: "Minimalist",
    room: "Bedroom",
    description: "Clean minimalist lines and subtle textures for modern sophistication",
  },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <motion.div
                ...
                className="flex items-center justify-center gap-3 text-sm text-gray-300 uppercase tracking-widest mb-8"
              >
              ...
              <motion.h1
                ...
                className="text-5xl sm:text-7xl lg:text-8xl font-bold text-white mb-4 uppercase tracking-wider"
              >
                <span className="text-[#ffb601]">{categoryConfig.title}</span>
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-2xl sm:text-3xl text-white/90 mb-6"
              >
              ...
              >
                <div className="text-center">
                  <p className="text-4xl font-bold text-[#ffb601]">
                    {wallpapers.length}+
                  </p>
                ...
                <div className="w-px h-12 bg-white/20" />
                <div className="text-center">
                  <p className="text-4xl font-bold text-[#ffb601]">Premium</p>
                  <p className="text-sm text-gray-400 uppercase tracking-wider">
                    Quality
                  </p>
                </div>
              ...
              {filteredWallpapers.map((wallpaper, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <h3 className="text-xl font-bold mb-2">{wallpaper.title}</h3>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#23282d]/80 to-transparent group-hover:opacity-0 transition-opacity duration-500">
                    <p className="text-white font-semibold">{wallpaper.title}</p>
        ...
        {selectedImage && (
          ...
          >
            ...
            <motion.button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/20 rounded-full flex items-center justify-center text-white hover:bg-[#ffb601] hover:text-[#23282d] transition-colors z-10"
            >
            ...
            <motion.button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/20 rounded-full flex items-center justify-center text-white hover:bg-[#ffb601] hover:text-[#23282d] transition-colors z-10"
            >
            ...
            <motion.div
              ...
              className="max-w-5xl w-full max-h-[90vh] flex flex-col lg:flex-row bg-white rounded-2xl overflow-hidden shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Image */}
              ...
              <div className="lg:w-1/3 p-8 flex flex-col">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-3 border-t border-gray-100">
                    ...
                    <span className="font-semibold text-[#23282d]">Premium</span>
                  </div>
                  <div className="flex items-center justify-between py-3 border-t border-gray-100">
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  >
                    <Heart
                      className={`w-5 h-5 ${
                        favorites.includes(selectedImage.id) ? "fill-current" : ""
                      }`}
                    />
